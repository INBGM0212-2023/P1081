...
MASTER_URL = rf"https://raw.githubusercontent.com/INBGM0212-2023/exercises/main/week-08/P1081"
...
def download_unit_test_suite(exercise_id: str, test_id: str) -> dict[str, any]:
